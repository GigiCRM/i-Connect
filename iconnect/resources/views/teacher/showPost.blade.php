...
<div class="container" >
    ...
    @foreach($posts as $posts)
        <div class="column" id="card-body" style="padding:20px; width:800px;">
                <div style="display:none;">id:{{$posts->id}}</div>
                <a href="{{route('teacher.deletePost', ['id' => $posts->id])}}" ><button id="button"class="btn btn-info" style="margin-left:20px;">Delete</button> </a>
                <a href="{{route('teacher.editPost', ['id' => $posts->id])}}" ><button id="button"class="btn btn-info" >Edit</button> </a>
